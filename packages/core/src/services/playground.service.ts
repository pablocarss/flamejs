...
<html>
  <head>
    <title>${docsConfig?.info?.title ?? 'Unnamed'} (${docsConfig?.info?.version ?? '1.0.0'}) - Flame Studio</title>
    <meta charset="utf-8" />
  ...
  <body>
    <header class="header">
      <img src="https://Flamejs.com/logo-light.svg" alt="Flame Logo" />
      ...
      <div class="header-actions">
        <div class="social-links">
         ...
         <a href="https://Flamejs.com" target="_blank" class="docs-link">
            <span>Powered By Flame.js</span>
...
class PlaygroundRequestHandler {
  ...
  async handle(request: Request, docsConfig?: DocsConfig, basePath?: string): Promise<Response> {
    try {
      ...
      logger.error('Error generating Flame Studio:', { error });
      return new Response('Internal Server Error', { status: 500 });
    }
  }
}

export function initializeFlamePlayground(docsConfig?: DocsConfig, basePath?: string): {
