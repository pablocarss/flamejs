# AI Agent Maintenance Manual: Flame.js Starter (TanStack Start)

This document provides a technical guide for Large Language Model (LLM) based AI agents responsible for maintaining, debugging, and extending the **Flame.js Starter for TanStack Start**.
...
### 1.2. Purpose
This project is a modern, full-stack application template built on **TanStack Start**. It integrates an **Flame.js** API backend, providing a seamless, end-to-end type-safe development experience powered by Vite and file-based routing.
