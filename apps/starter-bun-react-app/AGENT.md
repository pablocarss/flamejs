# Code Agent Instructions: Flame.js Starter (Bun REST API)
...
### 1.1. Name
Flame.js Starter: Bun + React Full-Stack SPA

### 1.2. Purpose
This project is a starter template for building high-performance, full-stack, type-safe Single Page Applications. It uses **Bun** as the all-in-one runtime, server, and bundler for both the server-side API and the client-side React frontend. **Flame.js** provides the robust, type-safe API layer.
