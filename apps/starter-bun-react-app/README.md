# Flame.js Starter: Bun + React Full-Stack App
...
Welcome to the Flame.js starter for building full-stack, type-safe applications with **Bun** and **React**. This template provides a solid foundation for creating modern, high-performance web applications with an end-to-end type-safe API layer.
...
-   **Type-Safe API**: Powered by Flame.js, ensuring type safety between your front-end and back-end.
...
1.  **Clone the Repository**
    ...
    cd Flame-js/apps/starter-bun-react-app
    ```
...
3.  **Configure Environment Variables**
    ...
    Create a `.env` file in the root of this starter (`Flame-js/apps/starter-bun-react-app/.env`) and add your Redis connection URL:
...
This starter combines a Bun server, a React front-end, and an Flame.js API into a single, cohesive application.
...
-   Requests to `/api/v1/*` are forwarded to the Flame.js API router.
...
### 2. The Flame.js API (`src/Flame.router.ts`)
...
-   **Main Component (`src/app/_app.tsx`)**: The root component that sets up providers, including the `FlameProvider` for the API client.
...
### 4. The Type-Safe Client (`src/Flame.client.ts`)

Flame.js automatically generates a type-safe client based on your API router definition.
