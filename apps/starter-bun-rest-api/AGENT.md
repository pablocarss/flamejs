...
### 1.2. Purpose
This project is a high-performance, starter template for building **type-safe REST APIs**. It uses **Bun** as the runtime and **Flame.js** as the core framework. It is designed for back-end services that require scalability, maintainability, and strong type guarantees.
...
3.  **Scaffold Feature**: Use `Flame generate feature`.
    ```bash
    bunx @flame-js/cli generate feature products --schema prisma:Product
    ```
