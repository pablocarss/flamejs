# Flame.js Real-Time Chat Example

[![Flame.js](https://img.shields.io/badge/Flame.js-v1-blue.svg)](https://Flamejs.com/)
[![Next.js](https://img.shields.io/badge/Next.js-14-blue.svg)](https://nextjs.org/)
[![React](https://img.shields.io/badge/React-18-blue.svg)](https://reactjs.org/)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0%2B-blue.svg)](https://www.typescriptlang.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

Welcome to the Flame.js Real-Time Chat Example! This project demonstrates how to build a full-stack, type-safe, real-time chat application using **Flame.js**, **Next.js**, and **Prisma**. It serves as a practical example of how to leverage Flame.js for building modern, high-performance web applications.
...
-   **End-to-End Type Safety**: Powered by Flame.js, ensuring type safety from your React components to your back-end API.
...
1.  **Clone the Repository**
    ```bash
    git clone https://github.com/felipebarcelospro/todo-Flame-project.git
    cd todo-Flame-project
    ```
...
This starter deeply integrates Flame.js with the Next.js App Router to create a real-time chat application.
...
-   **Initialization (`src/Flame.ts`)**: This is where the core Flame instance is created.
...
To learn more about Flame.js and its powerful features, check out the official resources:

-   **[Flame.js Website](https://Flamejs.com/)**
-   **[Flame.js GitHub Repository](https://github.com/felipebarcelospro/Flame-js)**
-   **[Follow on X](https://x.com/FlameJs)**
