...
export const metadata = generateMetadata({
  ...
  description: "Privacy policy for Flame.js framework. Learn about data handling, security practices, and privacy protection in our type-safe full-stack TypeScript framework.",
  canonical: "/privacy-policy",
  keywords: ["Privacy policy", "Flame.js", "Data protection", "Security", "Open source"]
});
