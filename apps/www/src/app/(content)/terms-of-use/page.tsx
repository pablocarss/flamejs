...
export const metadata = generateMetadata({
  title: "Terms of Use",
  description: "Terms of use for Flame.js, the type-safe full-stack TypeScript framework. Learn about licensing, usage rights, and legal terms.",
  canonical: "/terms-of-use",
  keywords: ["Terms of use", "Flame.js", "MIT License", "Legal terms", "Open source"]
});
    ...
    <main className="container mx-auto px-8 py-16 sm:py-12 md:py-16 max-w-screen-md">
      <section className="text-left mb-6 sm:mb-8 relative">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 md:mb-8 leading-tight md:max-w-4xl">
          Terms of Use for Flame.js Framework
        </h1>
        <p className="text-lg sm:text-xl mb-8 sm:mb-10 md:mb-12 text-muted-foreground">
          By using the Flame.js framework in your projects, you agree to comply
        ...
        <div className="grid grid-cols-1 gap-6 sm:gap-8">
          <div className="bg-secondary/10 p-6 sm:p-8 rounded-lg">
            ...
            <p className="text-base sm:text-lg text-muted-foreground">
              Flame.js is distributed under the MIT License. This means you are
          ...
          <div className="bg-secondary/10 p-6 sm:p-8 rounded-lg">
            ...
            <p className="text-base sm:text-lg text-muted-foreground">
              Flame.js is a type-safe full-stack TypeScript framework designed for modern web development. You
          ...
          <div className="bg-secondary/10 p-6 sm:p-8 rounded-lg">
            ...
            <p className="text-base sm:text-lg text-muted-foreground">
              Contributions to Flame.js are welcome. By submitting code changes
          ...
          <div className="bg-secondary/10 p-6 sm:p-8 rounded-lg">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="bg-gray-200 p-4 rounded-lg flex flex-col items-center">
                ...
                <a
                  href="https://github.com/felipebarcelospro/Flame-js"
                  target="_blank"
